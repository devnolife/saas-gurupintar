...
Volume: Pecahan Sederhana, Pertemuan 1`,
    ...
    saranaPrasarana:
      "Buku Matematika Kelas 3, Kue/Potongan Kertas berbentuk lingkaran, Papan Tulis, Spidol.",
    ...
    learningObjectives: [
      ...
      "Menunjukkan pecahan pada benda konkret (kue, kertas) secara tepat."
    ],
    activities: [
      ...
      "Penutup: Diskusi hasil percobaan, penugasan kecil untuk latihan di rumah (5 menit)"
    ],
    assessment:
      "Penilaian Sikap: Kedisiplinan dan keterlibatan dalam kegiatan praktek. Penilaian Pengetahuan: Tes singkat membedakan 1/2 dan 1/4. Penilaian Keterampilan: Kemampuan memotong kue/kertas secara proporsional.",
    refleksiGuru:
      "Apakah pendekatan praktik sudah membantu siswa memahami pecahan? Apa yang perlu ditingkatkan?",
    refleksiPesertaDidik:
      "Apakah kalian memahami perbedaan 1/2, 1/3, 1/4? Adakah bagian yang membingungkan?",
    pengayaanRemedial:
      "Pengayaan: Tantangan membagi kue menjadi 1/5, 1/6. Remedial: Pendampingan mengulang pemahaman pecahan 1/2, 1/4.",
    bahanBacaan:
      "Buku Siswa Matematika Kelas 3, Portal Rumah Belajar.",
    glosarium:
