  ...
  return (
    <section id="benefits" className="w-full bg-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <motion.p
          className="text-center text-light mb-12 max-w-2xl mx-auto text-lg"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Card className="h-full bg-white border-2 border-light hover:border-primary transition-colors duration-300 shadow-md hover:shadow-lg">
                <CardContent className="flex flex-col items-center text-center p-6">
                  ...
                  <p className="text-light">{benefit.description}</p>
                </CardContent>
              </Card>
            </motion.div>
          ))}
